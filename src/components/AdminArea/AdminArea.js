    ...
    <div className="adminArea">
      <div className="leftBar">
        ...
        <ul>
          <li
            onClick={() => {
              setOnPageRoute("manageBook");
            }}
          >
            <img src={editIcon} alt="" /> Manage Book
          </li>
          <li
            onClick={() => {
              setOnPageRoute("addBook");
            }}
          >
            <img src={gridIcon} alt="" /> Add Book
          </li>
          <li>
            <img src={plusIcon} alt="" /> Edit Book
          </li>
          <li>
            <Link to="/"> Home</Link>
          </li>
      ...
      <div className="rightShowcase">
        {onPageRoute === "manageBook" ? <ManageBooks /> : <AddBook />}
      </div>
    </div>
  );
};
